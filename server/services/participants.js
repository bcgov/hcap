...
const setParticipantStatus = async (
  ...
  // -- Rejecting a participant is allowed even if the participant has been hired elsewhere
  ...
  if ((status === 'prospecting' && item !== null && item.status !== 'open' && item.status !== 'rejected')
