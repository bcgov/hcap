    ...
    <Fragment>
      ...
      <Box mb={2}>
        <Card>
          ...
          <br />
          <Typography variant="body1">
            HCAP has many benefits for employers who will have the opportunity to access new provincially funded
            staffing and training resources and play a key role in building capacity in the BC health sector and
            economy.
          </Typography>
          <br />
          <Typography variant="body1">
            Participating employers will be provided with funding to cover education and salary costs for hire Health
            Care Support Workers who will provide critical non-clinical support while enrolled in a new modular
            Health Care Assistant training program. The HCAP will roll out as a partnership between candidates and
            employers to work through onboarding, orientation, employer-based training, and the HCA employer-
