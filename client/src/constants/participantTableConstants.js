...
const columns = {
  ...
  callbackStatus: { id: 'callbackStatus', name: 'Callback Status', sortOrder: 12 },
  userUpdatedAt: { id: 'userUpdatedAt', name: 'Last Updated', sortOrder: 13 },
  engage: { id: 'engage', name: null, sortOrder: 14 },
  ...
  lastEngagedBy: { id: 'lastEngagedBy', name: 'Last Engaged By', sortOrder: 15 },
  lastEngagedDate: { id: 'lastEngagedDate', name: 'Last Engaged Date', sortOrder: 16 },
