...
import { ApproveAccessRequestSchema, Routes, ToastStatus, regionLabelsMap, API_URL } from '../../constants';
...
export default () => {
  ...
  const handleSubmit = async (values) => {
    ...
    const response = await fetch(`${API_URL}/api/v1/${isUserAccessRequest ? 'approve-user' : 'user-details'}`, {
