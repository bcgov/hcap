...
server-create-build:
	@oc process -f openshift/server.bc.yml -p APP_NAME=$(APP_NAME) REF="ocp3-migration" IMAGE_TAG="dev" API_URL="https://hcap-server-f047a2-dev.apps.silver.devops.gov.bc.ca" | oc apply -n $(TOOLS_NAMESPACE) -f -
