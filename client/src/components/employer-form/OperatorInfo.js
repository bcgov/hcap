  ...
  return (
    <Card noShadow={isDisabled}>
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <Typography variant='subtitle2'>Operator Contact Information</Typography>
          <Divider />
        </Grid>

        <Box pt={1} pb={2} pl={2} pr={2}>
          <Typography variant='body1'>
            This section collects data on the site operator. Expressions of Interest should be made
            at the site level but an operator with multiple sites may submit more than one EOI which
            will be consolidated according to the data entered in this section.
          </Typography>
        </Box>
